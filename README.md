...
### Official Pre-built Binaries (v1.4.3)
...
- **Installer (Recommended):** Download `SafeVault.Setup.1.4.3.exe`. Double-click to install. This automatically registers start menu entries, desktop shortcuts, and links the application icons.
- **Portable Version:** Download `SafeVault.1.4.3.exe`. A single standalone binary that runs instantly without installation (useful for USB drives).

#### 🍎 macOS (Apple Silicon M1/M2/M3)
- **DMG Installer:** Download `SafeVault-1.4.3-arm64.dmg`. Double-click to open, and drag **SafeVault** to your `Applications` folder.
- **ZIP Archive:** Download `SafeVault-1.4.3-arm64-mac.zip`. Unpack and run the application directly.
...
- **AppImage:** Download `SafeVault-1.4.3.AppImage`. Run the following command in your terminal to make it executable and launch:
  ```bash
  chmod +x SafeVault-1.4.3.AppImage
  ./SafeVault-1.4.3.AppImage
  ```

#### 🤖 Android (Mobile / Tablet)
- **APK Installer:** Download `SafeVault-v1.4.3.apk`. Install it directly on your Android phone or tablet to run SafeVault natively.
